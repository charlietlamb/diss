...
export default function DataHybridAverage() {
  ...
  useEffect(() => {
    async function getData() {
      ...
      const loadData = {
        ...
        complexity: "average",
        time: timeTaken,
        cached: requests.includes("data/hybrid/average"),
      };
      ...
      if (!loadData.cached) {
        dispatch(setRequests([...requests, "data/hybrid/average"]));
      }
    }
    getData();
    return () => {
