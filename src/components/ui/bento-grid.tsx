...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento row-span-1 flex flex-col justify-between space-y-4 rounded-xl border border-white/[0.2] bg-black p-4 shadow-none shadow-input transition duration-200 hover:shadow-xl",
        className,
      )}
    >
      {header}
