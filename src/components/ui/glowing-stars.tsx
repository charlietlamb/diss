...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "h-full max-h-[8rem] w-full  rounded-xl p-4 py-8",
        className,
      )}
    >
      <div className="flex h-full max-h-[8rem] w-full items-center justify-center">
...
export const Illustration = ({ mouseEnter }: { mouseEnter: boolean }) => {
  ...
  return (
    <div
      className="h-48 max-h-[8rem] w-full p-1"
      style={{
        display: "grid",
